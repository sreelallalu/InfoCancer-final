 ...
 */
public class ImgBreast extends Fragment implements BackFragment{

      //  change
      private String Db_name=DATABASE_C.TABLE_NAME.T_IMGAGE+2;
      private static final String C_CANCER =IMGCON.BREAST;
